/****************************************************************************
** Meta object code from reading C++ file 'ViewInformation.hpp'
**
...
#error "The header file 'ViewInformation.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ViewInformation_t, stringdata) + ofs \
...
const QMetaObject ViewInformation::staticMetaObject = {
    { &View::staticMetaObject, qt_meta_stringdata_ViewInformation.data,
      qt_meta_data_ViewInformation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ViewInformation.stringdata))
