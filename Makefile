...
SOURCES       = main.cpp \
		MainWindow.cpp \
		FileReader.cpp \
		Pattern.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		MainWindow.o \
		FileReader.o \
		Pattern.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/DesignPattern1.0.0/ && $(COPY_FILE) --parents MainWindow.hpp FileReader.hpp Pattern.hpp .tmp/DesignPattern1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp FileReader.cpp Pattern.cpp .tmp/DesignPattern1.0.0/ && (cd `dirname .tmp/DesignPattern1.0.0` && $(TAR) DesignPattern1.0.0.tar DesignPattern1.0.0 && $(COMPRESS) DesignPattern1.0.0.tar) && $(MOVE) `dirname .tmp/DesignPattern1.0.0`/DesignPattern1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/DesignPattern1.0.0
