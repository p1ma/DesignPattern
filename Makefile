...
SOURCES       = main.cpp \
		FileReader.cpp \
		Pattern.cpp \
		GraphicModel.cpp moc_GraphicModel.cpp
OBJECTS       = main.o \
		FileReader.o \
		Pattern.o \
		GraphicModel.o \
