...
SOURCES       = main.cpp \
		...
		ViewAnswers.cpp \
		Model.cpp \
		ViewQuiz.cpp moc_GraphicModel.cpp \
		moc_ViewPattern.cpp \
		moc_ViewAnswers.cpp \
		moc_ViewQuiz.cpp
OBJECTS       = main.o \
