...
SOURCES       = main.cpp \
		...
		FileWriter.cpp \
		ViewInformation.cpp \
		ViewStart.cpp qrc_DesignPattern.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/DesignPattern1.0.0/ && $(COPY_FILE) --parents DesignPattern.qrc .tmp/DesignPattern1.0.0/ && $(COPY_FILE) --parents FileReader.hpp Pattern.hpp GraphicModel.hpp View.hpp ViewPattern.hpp ViewAnswers.hpp Model.hpp ViewQuiz.hpp MenuBar.hpp FileWriter.hpp ViewInformation.hpp ViewStart.hpp .tmp/DesignPattern1.0.0/ && $(COPY_FILE) --parents main.cpp FileReader.cpp Pattern.cpp GraphicModel.cpp View.cpp ViewPattern.cpp ViewAnswers.cpp Model.cpp ViewQuiz.cpp MenuBar.cpp FileWriter.cpp ViewInformation.cpp ViewStart.cpp .tmp/DesignPattern1.0.0/ && (cd `dirname .tmp/DesignPattern1.0.0` && $(TAR) DesignPattern1.0.0.tar DesignPattern1.0.0 && $(COMPRESS) DesignPattern1.0.0.tar) && $(MOVE) `dirname .tmp/DesignPattern1.0.0`/DesignPattern1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/DesignPattern1.0.0
...
moc_MenuBar.cpp: /usr/include/qt5/QtWidgets/QMenuBar \
		/usr/include/qt5/QtWidgets/qmenubar.h \
		/usr/include/qt5/QtWidgets/qmenu.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
...
ViewInformation.o: ViewInformation.cpp ViewInformation.hpp \
		View.hpp \
		/usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtWidgets/qlabel.h \
		/usr/include/qt5/QtWidgets/qframe.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ViewInformation.o ViewInformation.cpp

ViewStart.o: ViewStart.cpp ViewStart.hpp \
		View.hpp \
		/usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtWidgets/qlabel.h \
		/usr/include/qt5/QtWidgets/qframe.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ViewStart.o ViewStart.cpp
